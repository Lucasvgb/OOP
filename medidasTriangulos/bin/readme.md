...
* Primeiro foi feito o problema usando programação estruturada, sem nenhum vínculo com orientação a objetos. Depois foi feito o mesmo problema, porém usando os princípios de POO.
